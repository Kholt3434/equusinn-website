...
const photos: GalleryPhoto[] = [
  ...
  {
    id: 29,
    src: `${CDN}/OneQueenSuiteADAShower.jpg`,
  ...
  {
    id: 30,
    src: `${CDN}/TwoQueenSuiteADABed.jpg`,
  ...
  {
    id: 31,
    src: `${CDN}/_14KingSuiteADAShower.jpg`,
  ...
  {
    id: 33,
    src: `${CDN}/TwoQueenSuiteADALivingArea.jpg`,
  ...
  {
    id: 34,
    src: `${CDN}/TwoQueenRoomNoCHair.webp`,
    alt: "Equus Inn Two Queen room",
    category: ["all", "rooms"],
  ...
  {
    id: 35,
    src: `${CDN}/beerandwinearea(2).webp`,
